  ...
  return (
    <Link to={`/book/:${book.bookid}`}>
      <div key={book.bookid} className='mb-10'>
        <div className="md:w-[350px] md:h-[600px] w-[200px] p-4 flex flex-col justify-center gap-6 text-white items-center cursor-pointer hover:border-b-4 hover:border-t-4 hover:border-secondary hover:shadow-2xl border-solid transition duration-500 ease-in-out">
